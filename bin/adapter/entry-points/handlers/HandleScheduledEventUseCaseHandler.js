...
const awaitingQualityCheckViewerWriter_1 = require("./awaitingQualityCheckViewerWriter");
    ...
    constructor() {
        this.handle = async (configFilePath, _verbose) => {
            ...
            const mergedInput = {
                ...
                awaitingQualityCheckViewerOutputPath: readmeConfig.awaitingQualityCheckViewerOutputPath ??
                    input.awaitingQualityCheckViewerOutputPath,
                awaitingQualityCheckDoneStorePath: readmeConfig.awaitingQualityCheckDoneStorePath ??
            ...
            const donePrUrls = mergedInput.awaitingQualityCheckDoneStorePath
                ? (0, awaitingQualityCheckViewerWriter_1.readDoneStorePrUrls)(mergedInput.awaitingQualityCheckDoneStorePath)
                : null;
            ...
            if (result) {
                ...
                if (result.viewerOutput !== null &&
                    mergedInput.awaitingQualityCheckViewerOutputPath) {
                    (0, awaitingQualityCheckViewerWriter_1.writeAwaitingQualityCheckViewerFile)(result.viewerOutput, mergedInput.awaitingQualityCheckViewerOutputPath);
                }
