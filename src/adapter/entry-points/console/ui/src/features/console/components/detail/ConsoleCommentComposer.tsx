...
export type ConsoleCommentComposerProps = {
	...
	onCommentAndAwaitingWorkspace?: () => void;
};
...
export const ConsoleCommentComposer = ({
	...
	const submit = async (afterSuccess?: () => void): Promise<void> => {
				...
				<div className="console-composer-form">
					...
					<div className="console-composer-row">
						...
						{onOkAndAwaitingWorkspace !== undefined && (
							...
							>
								Ok &amp; MOVE to Awaiting Workspace
							</button>
						)}
						{onCommentAndAwaitingWorkspace !== undefined && (
							<button
								type="button"
								className="console-composer-submit"
								disabled={status.kind === "posting"}
								onClick={() => {
									void submit(onCommentAndAwaitingWorkspace);
								}}
							>
								Comment &amp; MOVE to Awaiting Workspace
							</button>
						)}
						<button
							type="button"
