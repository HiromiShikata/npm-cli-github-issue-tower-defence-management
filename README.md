...
Options for notifyFinishedIssuePreparation:
  ...
  --ownerApprovalTimeoutCycles <count>             Number of owner-approval wait cycles before escalating to Failed Preparation (default: 12)
...
ownerApprovalTimeoutCycles?: number # Optional: Number of owner-approval wait cycles before escalating to Failed Preparation (default: 12)
