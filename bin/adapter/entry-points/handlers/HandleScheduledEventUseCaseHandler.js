...
class HandleScheduledEventUseCaseHandler {
    constructor() {
        this.handle = async (configFilePath, _verbose) => {
            ...
            const claudeTokenUsageRepository = new ProxyClaudeTokenUsageRepository_1.ProxyClaudeTokenUsageRepository(mergedInput.startPreparation?.claudeCodeOauthTokenListJsonPath ?? null);
