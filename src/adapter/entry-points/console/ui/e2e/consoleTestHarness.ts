      ...
      items: [
        {
          ...
          url: `https://github.com/${REPO_NAME_WITH_OWNER}/pull/867`,
          repo: REPO_NAME_WITH_OWNER,
          nameWithOwner: REPO_NAME_WITH_OWNER,
        ...
        },
        {
          ...
          title:
            'Auto-advance to the next non-empty console tab when one empties',
          url: `https://github.com/${REPO_NAME_WITH_OWNER}/issues/869`,
          repo: REPO_NAME_WITH_OWNER,
          nameWithOwner: REPO_NAME_WITH_OWNER,
          projectItemId: 'PVTI_lADOABCD1234zgTODO00869',
          itemId: 'PVTI_lADOABCD1234zgTODO00869',
          isPr: false,
          story: 'TDPM Console port',
          status: null,
          agent: null,
          ...
          dependedIssueUrls: [],
          labels: [],
          createdAt: '2026-06-18T00:14:51.000Z',
          relatedOpenPullRequestUrls: [],
        },
      ],
    },
  ...
  const server = await startWebServer({
    ...
    issueRepository: {
      ...
      ...(options?.getIssueOrPullRequestComments !== undefined
        ...
        : {}),
      ...(options?.createNewIssueError !== undefined
        ? {
            createNewIssue: async (): Promise<never> => {
              throw options.createNewIssueError;
            },
          }
        : {}),
    },
