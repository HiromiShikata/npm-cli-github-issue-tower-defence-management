...
export class CreateEstimationIssueUseCase {
  ...
  run = async (input: {
    ...
    for (const story of input.project.story?.stories || []) {
      ...
      const completionDate50PercentConfidenceField =
        input.project.completionDate50PercentConfidence;
  ...
  createEstimationIssueBody = (
    ...
    return `This issue is experimental workflow :pray:
