...
startPreparation?: # Optional: Enable automatic issue preparation workflow
  ...
  labelToLlmAgent?: Record<string, string> | null # Optional: Mapping from issue label to LLM agent name. When an issue carries a label that matches a key in this map, the mapped agent is used. Selection precedence is: (1) explicit `llm-agent:` label, (2) labelToLlmAgent mapping, (3) `category:` label, (4) defaultLlmAgentName, (5) defaultAgentName
...
labelToLlmAgent?: Record<string, string> # Optional: Mapping from issue label to LLM agent name. When an issue carries a label that matches a key in this map, the mapped agent is used. Selection precedence is: (1) explicit `llm-agent:` label, (2) labelToLlmAgent mapping, (3) `category:` label, (4) defaultLlmAgentName, (5) defaultAgentName
```
