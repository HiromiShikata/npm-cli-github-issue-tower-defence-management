...
exports.ProcTakeOwnershipSpawnRepository = void 0;
...
const extractLogPath = (cmdline) => {
    const match = cmdline.match(LOG_PATH_PATTERN);
    return match === null ? null : match[0];
};
class ProcTakeOwnershipSpawnRepository {
    constructor(procDirectory = DEFAULT_PROC_DIRECTORY) {
        ...
        this.readSpawn = (processIdDirectory) => {
        ...
        this.readRawCmdline = (processIdDirectory) => {
...
exports.ProcTakeOwnershipSpawnRepository = ProcTakeOwnershipSpawnRepository;
//# sourceMappingURL=ProcTakeOwnershipSpawnRepository.js.map